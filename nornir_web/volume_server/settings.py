...
'''
VOLUME_SERVER_COORD_SPACE_NAME = getattr(settings, "VOLUME_SERVER_COORD_SPACE_NAME", "Grid")
...
VOLUME_SERVER_COORD_SPACE_PROFILE_ENABLED = getattr(settings, "VOLUME_SERVER_COORD_SPACE_PROFILE_ENABLED", False)
